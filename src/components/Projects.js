...
function Projects() {
  const Projects = [
    ...
    },
    {
      ...
      photo: "img/projects/angular.png",
    },
    {
      id: 9,
    ...
    //   name: "Devops Project",
    //   description:
    //     "Implement all the links in the delivery chain of a Spring Boot application.",
    ...
    //   description:
    //     "The purpose of this project is to become familiar with the Microservices architecture and its various elements.",
